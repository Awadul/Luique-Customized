...
const PortfolioIsotope = ({ noViewMore }) => {
  ...
  const projects = [
    ...
    { title: "Ochanya Nurse Run", categories: ["sorting-unity", "sorting-action-adventure"], image: "assets/images/work2.jpeg", description: "Engaging gameplay with responsive UI mechanics.", href: "/work-single" },
